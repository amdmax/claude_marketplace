...
| 3 - View details | Display full `.agile-dev-team/active-story.json`, then re-prompt |
...
mv "$CLAUDE_PROJECT_DIR/.agile-dev-team/active-story.json" \
   "$CLAUDE_PROJECT_DIR/.agile-dev-team/active-story-${TIMESTAMP}.json"

echo "✓ Previous story archived to .agile-dev-team/active-story-${TIMESTAMP}.json"
```
...
**Expected output:**
- `.agile-dev-team/active-story.json` created with story data
...
- NFRs written to `.agile-dev-team/technical-context.json`
...
- Context written to `.agile-dev-team/technical-context.json`
...
- ADR reference written to `.agile-dev-team/technical-context.json`
...
Partial progress saved to .agile-dev-team/active-story.json
...
3. /gh:commit               (create commits with AIGCODE-###)
...
ls "$CLAUDE_PROJECT_DIR/.agile-dev-team/active-story-"*.json

# Remove old archives (keep last 5)
ls -t "$CLAUDE_PROJECT_DIR/.agile-dev-team/active-story-"*.json | tail -n +6 | xargs rm
```
