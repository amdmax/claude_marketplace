...
### Step 2: Load Story and Technical Context
...
// Extract data
const { issueNumber, title, body, labels } = story;
const { nfrs, context } = techContext;
```
...
### Step 13: Update technical-context.json with ADR Reference
...
✓ ADR reference saved to .agile-dev-team/technical-context.json
```
