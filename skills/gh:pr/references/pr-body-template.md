...
### {ISSUE_TITLE}
**Source:** `.agile-dev-team/active-story.json` → `title` field
...
### {ISSUE_NUMBER}
**Source:** `.agile-dev-team/active-story.json` → `issueNumber` field
...
### {ISSUE_URL}
**Source:** `.agile-dev-team/active-story.json` → `url` field
