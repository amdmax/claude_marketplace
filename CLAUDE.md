...
| `github` | `github:actions`, `github:create-issue`, `github:edit-workflow`, `github:merge-chores`, `github:pull-request`, `github:runner-setup`, `github:story-create`, `github:story-fetch`, `github:story-finalize`, `github:story-play`, `github:story-quality`, `github:tidy-board`, `github:until-green`, `ready-for-dev-scout` | GitHub-hosted workflow — issues, PRs, CI loops, story lifecycle, board management, runner setup, and sequential chore merging |
...
| `content-specialized` | `add-content-image`, `creative-writing`, `css-architecture`, `cuda-remote-manager`, `design-system`, `editor-in-chief`, `regenerate-course-content`, `reveal-pdf-export`, `ux-professional` | Content creation and specialized tools — writing, CSS, UX, design systems, documentation |
