...
| `architect-scout` | `arch:generate-strategic-questions`, `arch:generate-tactical-questions` | Architect scout question generation — strategic (enterprise/org-level) and tactical (implementation-level) questions for scout to answer before implementation begins |
