...
| `cc` | `claude:hooks`, `claude:plugin-scaffold`, `claude:refactor-skill`, `claude:skill-creator`, `claude:sync-skills`, `claude:validate-skills` | Claude Code meta-skills — hooks, plugin scaffolding, skill creation, refactoring, syncing, and validation |
