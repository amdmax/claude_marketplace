...
3. Check `$AGENT_DOCS_DIR/active-story.yaml` and `$AGENT_DOCS_DIR/development-progress.yaml` for context
...
5. Write your implementation brief to `$AGENT_DOCS_DIR/development-progress.yaml` (`teamState.implementationBrief`)
